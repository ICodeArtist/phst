    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      <a-form-item>
        <a-input
          ...
          type="text"
          placeholder="姓名"
          v-decorator="['username', {rules: [{ required: true, message: '请输入姓名' }], validateTrigger: ['change', 'blur']}]"
        ></a-input>
      </a-form-item>
      <a-form-item>
        <a-input
...
import { getSmsCaptcha, toRegPhar } from '@/api/login'
      ...
      validateFields(['mobile'], { force: true },
        (err, values) => {
          if (!err) {
            ...
            getSmsCaptcha({ phone: values.mobile, type: '4' }).then(res => {
