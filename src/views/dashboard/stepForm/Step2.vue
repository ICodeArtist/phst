  ...
  <div>
    <a-spin :spinning="spinning" tip="上传中...">
      <a-form layout="vertical" :form="form" style="max-width: 500px; margin: 40px auto 0;">
        ...
        >
          <a-upload
            v-decorator="['sfzzm', { rules: [{required: true, message: '营业执照副本必填'}] }]"
            accept="image/*"
            name="file"
        ...
        >
          <a-upload
            v-decorator="['sfzfm', { rules: [{required: true, message: '药品经营许可证必填'}] }]"
            accept="image/*"
            name="file"
            action="https://askapp.wxori.top/index/uploadfile"
            list-type="picture"
        ...
        >
          <a-upload
            v-decorator="['zyjszgzm', { rules: [{required: true, message: '药品质量管理规范证书必填'}] }]"
            accept="image/*"
            name="file"
            action="https://askapp.wxori.top/index/uploadfile"
            list-type="picture"
        ...
        >
          <a-upload
            v-decorator="['zyjszgfm', { rules: [{required: true, message: '药品质量管理规范证书必填'}] }]"
            accept="image/*"
            name="file"
            action="https://askapp.wxori.top/index/uploadfile"
            list-type="picture"
